...
class PendingFriendshipsFeed extends feed_1.Feed {
    ...
    async items() {
        ...
        return body.users.map(user => (0, class_transformer_1.plainToClassFromExist)(new responses_1.PendingFriendshipsFeedResponseUsersItem(this.client), user));
    }
}
__decorate([
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], PendingFriendshipsFeed.prototype, "nextMaxId", void 0);
