...
exports.BlockedUsersFeed = void 0;
...
class BlockedUsersFeed extends feed_1.Feed {
    ...
    async items() {
        ...
        return body.blocked_list.map(user => (0, class_transformer_1.plainToClassFromExist)(new responses_1.BlockedUsersFeedResponseBlockedListItem(this.client), user));
    }
}
__decorate([
